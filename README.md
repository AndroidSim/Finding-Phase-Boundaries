...
Before analysis, the derivative ESR spectra were integrated into absorbance spectra and then normalized to unit area.   Each absorbance spectrum is converted into an absorbance data vector, which is a discretization of the absorbance intensity versus magnetic field.  The ESR data vectors from sample compositions along the binary axis were organized into a spectral data matrix, S, with the number of rows (M) equal to the number of discrete magnetic field values and the number of columns (N) equal to the number of compositional points sorted by mole fraction from 0 to 1.  This data matrix has the following structure,
 ...
 <img width="200" height="40" alt="image" src="https://github.com/user-attachments/assets/10cb6433-57a0-4db9-b56b-57c5107df103" /> (Eqn. 1.1)			
...
<img width="200" height="100" alt="image" src="https://github.com/user-attachments/assets/832ddffb-ebbd-41eb-927d-eb7b16f6729a" /> (Eqns. 1.2)
...
<img width="300" height="150" alt="image" src="https://github.com/user-attachments/assets/fb645e98-fc24-4f72-8ec4-4beb3917a862" /> (Eqn. 1.3)

with constraints on the coefficients,

<img width="150" height="150" alt="image" src="https://github.com/user-attachments/assets/a64cc91a-a3b4-4664-8079-cc4e4e45bee8" /> (Eqn. 1.4)
...
<img width="200" height="100" alt="image" src="https://github.com/user-attachments/assets/d5d8bc16-940b-45aa-8253-dd8d857368fd" /> (Eqn. 1.5)
					                        
the coexistence spectra can be written in matrix form,

<img width="150" height="50" alt="image" src="https://github.com/user-attachments/assets/1d9ad863-4e9c-4866-aab5-1908ce3cf329" /> (Eqn. 1.6)
...
<img width="150" height="50" alt="image" src="https://github.com/user-attachments/assets/24a7a730-6d2b-49f7-aca3-3d5b99adf967" />

where the f* matrix (2 x N)  is the f matrix extended by N−X rows of [1 0] for the alpha phase or [0 1] for the beta phase,

<img width="200" height="200" alt="image" src="https://github.com/user-attachments/assets/a25b720c-2169-47b0-a2cc-96c58a6d8063" /> (Eqn. 1.7)
...
<img width="300" height="60" alt="image" src="https://github.com/user-attachments/assets/cfbcd23b-b902-4ac9-99fc-cdec4a0a6ef3" /> (Eqn. 1.8)		
...
<img width="200" height="40" alt="image" src="https://github.com/user-attachments/assets/825f7407-b057-4f2e-8c91-c7ea100998aa" /> (Eqn. 1.9)
